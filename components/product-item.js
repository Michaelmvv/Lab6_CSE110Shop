...
//     <p class="title">Fjallraven - Foldstack No. 1 Backpack, Fits 15
//     Laptops</p> <p class="price">$109.95</p> <button onclick="alert('Added to
...
class ProductItem extends HTMLElement {
  constructor(foo) {
    ...
    img.setAttribute('src', foo['image']);
    img.setAttribute('alt', foo['title']);

    const title = wrapper.appendChild(document.createElement('p'));
    title.setAttribute('class', 'title');
    title.textContent = foo['title'];
